...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice == '1':
            ...
            low_thresh = int(input("Enter lower threshold: "))
            upper_thresh = int(input("Enter upper threshold: "))
            edges = cv2.Canny(gray_image, low_thresh, upper_thresh)
...
interactive_edge_detection("/Users/aadrita/python_codes/lesson10/i2.jpeg")  